...
//		update();
	...
	private static void adduser() throws Exception {
		...
		int i = stmt.executeUpdate(
				"insert into st_user values(1, 'sandeep','gurjar', 'sandeep@gmail.com', 'pass123','indore', '2001-02-02')");
	...
	private static void update() throws Exception {
		...
		int i = stmt.executeUpdate("update st_user set firstname = 'sandeep' where id = 1;");
	...
	private static void search() throws Exception {
		...
		System.out.println(" search data successfully:-");

		System.out.println("id\tfirst\tlast\tuser\t\tpass\t\taddres\tdate");
		System.out.println("--------------------------------------------------------------------------");
		System.out.println("\t");
